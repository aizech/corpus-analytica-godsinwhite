...
class GPTImage1Tools(Toolkit):
    ...
    async def create_image(self, agent: Union[Agent, Team], prompt: str) -> str:
        ...
        try:
            ...
            log_debug(
                f"API parameters: model={self.model}, n={self.n}, size={self.size}"
            )
                ...
                for img in response.data:
                    ...
                    if hasattr(img, "url") and img.url:
                        ...
                        image_artifact = Image(
                            ...
                            alt_text=prompt[
                                :200
                            ],  # Use first 200 chars of prompt as alt text
                    ...
                    # Handle base64-encoded images (typical for gpt-image-1)
                        ...
                        try:
                            ...
                            try:
                                ...
                                await add_message(
                                    "assistant",
                                    f"I've generated an image based on your request: {prompt} \n The image is saved to: {img_path}",
                                    images=[image_artifact],
                                )
                            except Exception as import_error:
                                log_debug(
                                    f"Could not import add_message: {import_error}"
                                )
                            ...
                            response_str += (
                                "Image was generated but could not be saved locally.\n"
                            )
